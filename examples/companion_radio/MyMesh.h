...
public:
  ...
  // To check if there is pending work (used in main.cpp loop for sleep)
...
private:
  ...
  void saveContacts() { _store->saveContacts(this, save_filter); }
...
public:
  ...
  // Off-Grid Mode: Radio-Parameter sichern/wiederherstellen + client_repeat setzen
  bool isOffGridActive() const { return _prefs.client_repeat != 0; }
  void toggleOffGrid();
