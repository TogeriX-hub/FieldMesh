...
- [8. FieldMesh Fork — FAQ](#8-fieldmesh-fork--faq)
...
## 8. FieldMesh Fork — FAQ

> Questions specific to [FieldMesh](https://github.com/TogeriX-hub/FieldMesh), a MeshCore fork optimized for outdoor and off-grid use.
